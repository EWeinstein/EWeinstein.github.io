...
I'm a 6th year PhD student in the Program in Biophysics at Harvard University, advised by Debora Marks ([link](https://marks.hms.harvard.edu/index.html)) and Jeff Miller ([link](https://jwmi.github.io/)). I develop statistical tools for molecular biology, working in the fields of Bayesian statistics, probabilistic machine learning, biophysics and genomics. In Summer 2022, I will be joining David Blei's group ([link](http://www.cs.columbia.edu/~blei/)) at Columbia University as a postdoctoral fellow.
